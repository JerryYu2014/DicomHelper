...
class WriteDicom(object):
    ...
    def parse_arguments(self, description, subparser, command):
        ...
        parser.add_argument("-d", "--dataset", dest="dataset", default='', help="the dataset for write dicom file")
        parser.add_argument("-f", "--filename", dest="filename", default='', help="the filename of output dicom file")
